  ...
  _createClass(FooterActions, [{
    ...
    value: function getFiveRecentMovies() {
      ...
      $.ajax(request).done(function (data) {
        _this.getFiveRecentMoviesSuccess(data);
      });
...
var Navbar = function (_React$Component) {
  ...
  _createClass(Navbar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'nav',
        { className: 'nvbar navbar-default navbar-static-top' },
        _react2.default.createElement(
          'div',
...
var MovieAddStore = function () {
  ...
  _createClass(MovieAddStore, [{
    ...
    value: function onAddMovieFail(err) {
      console.log('Failed to ad movie', err);
    }
  }, {
...
var Helper = function () {
  ...
  _createClass(Helper, null, [{
    ...
    key: 'propendToArray',
    value: function propendToArray(value, array) {
      array.unshift(value);
    ...
    value: function nodesMovieCard(state, props, toggleCommentsPanel, toggleVotePanel) {
      ...
      nodes.panelToggles = _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { className: 'btn btn-primary', onClick: toggleCommentsPanel },
          state.showCommentsPanel ? 'Hide' : 'Comments'
        ),
        _react2.default.createElement(
          'a',
          { className: 'btn btn-primary', onClick: toggleVotePanel },
