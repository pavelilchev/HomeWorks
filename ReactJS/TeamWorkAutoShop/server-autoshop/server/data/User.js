...
const USERNAME_UNIQUE = '{PATH} already exist'
...
let userSchema = new mongoose.Schema({
  username: { type: String, required: REQUIRED_VALIDATION_MESSAGE, unique: USERNAME_UNIQUE, minlength: USERNAME_MINLEN_MESSAGE, maxlength: USERNAME_MAXLEN_MESSAGE },
