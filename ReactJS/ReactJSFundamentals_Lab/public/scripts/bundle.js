  ...
  _createClass(MovieActions, [{
    ...
    value: function addVote(movieId, score) {
      ...
      $.ajax(request).done(function (data) {
        ...
        _this4.addVoteFail(err.responseJSON);
      });
    }
  }]);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'a',
                { href: 'https://github.com/pavelilchev' },
                _react2.default.createElement(
                  'strong',
                  null,
                  'Pavel Ilchev'
  ...
  _createClass(UserProfile, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_UserInfo2.default, { name: this.state.name, roles: this.state.roles, information: this.state.information }),
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { validationState: this.state.genderValidationState, message: this.state.message },
...
var VoteToggle = function (_React$Component) {
  ...
  _createClass(VoteToggle, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'a',
        { className: 'btn btn-primary', onClick: this.props.toggleVotePanel },
  ...
  _createClass(MoviePanelToggles, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { className: 'btn btn-primary', onClick: this.props.toggleCommentsPanel },
          this.props.showCommentsPanel ? 'Hide' : 'Comments'
        ),
        _react2.default.createElement(_Authorize.Concealer, { ChildComponent: VoteToggle, toggleVotePanel: this.props.toggleVotePanel, showVotePanel: this.props.showVotePanel }),
        _react2.default.createElement(
          _reactRouter.Link,
...
var Concealer = exports.Concealer = function (_React$Component2) {
  ...
  _createClass(Concealer, [{
    ...
    key: 'render',
    value: function render() {
      var ChildComponent = this.propsChildComponent;
      return this.stateloggedInUserId ? _react2.default.createElement(ChildComponent, this.props) : null;
    }
  }]);
