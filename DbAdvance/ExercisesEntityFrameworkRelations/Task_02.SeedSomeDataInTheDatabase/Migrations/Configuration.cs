namespace Task_02.SeedSomeDataInTheDatabase.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<StudentsSystemContext>
    {
        public Configuration()
        {
            ...
            this.ContextKey = "Task_02.SeedSomeDataInTheDatabase.StudentsSystemContext";
        }
        ...
        private static void SeedResources(StudentsSystemContext context)
        {
            ...
            context.Resources.AddOrUpdate(resource1, resource2, resource3);
            context.SaveChanges();
        }
